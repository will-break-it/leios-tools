# Push vs pull: the 108-run study

Part of the [vote diffusion findings](../vote-diffusion/README.md). Arm names are defined in [transports.md](../vote-diffusion/transports.md); limits are listed in [model-gaps.md](../vote-diffusion/model-gaps.md).
